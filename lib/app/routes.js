module.exports = function (app) {
  ...
  app.get('/settings', function (page, model) {
    model.setNull('_page.form.changeUsername.username', model.get('_page.user.public.local.username'));
    model.setNull('_page.form.changeEmail.email', model.get('_page.user.private.local.emails.0.value'));
